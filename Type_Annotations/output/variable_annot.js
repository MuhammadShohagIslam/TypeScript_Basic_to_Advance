...
let fullName = "Muhammad Jhohirul Islam Shohag";
...
let isIncomeSource = undefined;
console.log(isIncomeSource);
// array type annotation
const mobileCompany = ["Samsung", "Apple"];
console.log(mobileCompany);
const mobileSells = [120, 120];
console.log(mobileCompany);
const mobileIsGood = [true, true];
console.log(mobileCompany);
